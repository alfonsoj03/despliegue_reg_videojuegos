...
Original file is located at
    https://colab.research.google.com/drive/18cKYzzMclbToQjuKs41xcDp2Mqp2PjMw
...
# En despliegue drop_first siempre en falso
...
# Hay que añadir las columnas faltantes (los dummies que no estaban en los datos a predecr y que por ende no se crearon)
# Reindex además borra lo que no me sirve, por ejemplo los dummies adicionales al no hacer drop first.
data_preparada = data_preparada.reindex(columns = variables, fill_value=0)
data_preparada.head()

## Se normaliza la edad para predecir con Knn, Red N, SVM
# En los despliegues no se llama a fit
# Importante: NO SE HACE NORMALIZACION EN ARBOLES
...
st.warning("el modelo tiene un error del 2%")
